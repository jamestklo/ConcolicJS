...
For programmers, JavaScript is relatively easy to adopt, and does not have the burden of memory management and static typing.
...
In the {\tt function checkRows()} in Sample Code \ref{dom0}, we must visit both the {\tt True} and {\tt False} branches of the {\tt If} statement.
\begin{figure}
...
For example, {\tt field} can have any number of children in in Sample Code ~\ref{dom0}.  Thus the loop can get iterated any number of times.  
