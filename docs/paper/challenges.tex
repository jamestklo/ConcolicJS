...
Our goal in this work is to provide an automatic targeted solution for generating satisfiable DOM trees. These generated DOM tress would serve as \emph{test fixtures} in \js unit tests, facilitating proper code execution and coverage.
